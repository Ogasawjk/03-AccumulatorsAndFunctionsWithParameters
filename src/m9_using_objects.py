...
def circle_and_rectangle():
    ...
    rec_center = rg.Point((C1.x-C2.x)/2,(C1.y-C2.y)/2)
...
def lines():
    ...
    start1 = rg.Point(200, 500)
    end1 = rg.Point(500, 750)

    start2 = rg.Point(50, 750)
    end2 = rg.Point(750, 50)

    L1 = rg.Line(start1, end1)
    L2 = rg.Line(start2, end2)
